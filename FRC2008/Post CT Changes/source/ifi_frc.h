...
*	09-Feb-2008  0.5  RKW - Moved the call to Getdata() before the various
*	                  Init functions.
*	12-Feb-2008  0.6  RKW - Modified the main() function to guarantee that
*	                  the various spin functions are executed at least once
*	                  per cycle.
*	12-Feb-2008  0.6  RKW - Added support for the MPLAB simulation tool.
*
*******************************************************************************/
#ifndef _ifi_frc_h
#define _ifi_frc_h
...
#define rc_ana_in09		9
#define rc_ana_in10		10
#define rc_ana_in11		11
#define rc_ana_in12		12
#define rc_ana_in13		13
#define rc_ana_in14		14
#define rc_ana_in15		15
#define rc_ana_in16		16
