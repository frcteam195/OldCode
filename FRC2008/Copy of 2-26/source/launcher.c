...
void Launcher_State_Machine(void){
    ...
    static unsigned char brake_ticks=0,cal_ticks=0,home_lock_ticks=0,brake=0;
    pot_bottom = POT_FLOOR;
    //get the launcher pot value
    launcher_pot = Get_ADC_Result(1);
    ...
    switch(state)
    {
        ...
        case LAUNCHING:
            ...
            if(launcher_pot != launcher_pot_old){//dont launch until the brake releases
