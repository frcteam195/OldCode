...
*	09-Feb-2008  0.8  RKW - Modified Process_Gyro_Data to optionally call
*	                  Reset_ADC_Result_Count() when finished processing ADC
*	                  data.
*
*******************************************************************************/
...
*
*******************************************************************************/
void Process_Gyro_Data(unsigned char Reset_ADC_Count)
{
	int temp_gyro_rate;
